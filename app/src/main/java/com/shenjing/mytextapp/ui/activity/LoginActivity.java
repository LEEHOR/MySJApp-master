...
import com.shenjing.mytextapp.utils.Md5Utils;
...
public class LoginActivity extends BaseActivity<LoginActivityPresenter> implements LoginActivityContract.View {
    ...
    @Override
    public void showLoginSuccess(LoginModule loginModule, int type) {
    ...
    @Override
    public void shownLoginFailure(LoginModule loginModule, int type) {
