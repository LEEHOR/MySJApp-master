 ...
 * desc   :银行总行
*/
public class adapterBranchBank extends BaseQuickAdapter<SubBranchBank, BaseViewHolder> {
    ...
    public adapterBranchBank() {
        super(R.layout.item_selectbank);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, SubBranchBank item) {
        if (item != null) {
            ...
            tv.setText(item.getSubBranchName());
